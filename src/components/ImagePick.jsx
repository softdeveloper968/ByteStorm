...
export default function ImagePicker({ currentImage, setPick, label, name }) {
  ...
  return (
    <main className="text-mw_black">
      <p className="text-lg text-center w-full mb-4">{label}</p>
      ...
      <div className="flex flex-col items-center">
        ...
        <button
          type="button"
          className="bg-white text-xl border-mw_gray border-2 rounded-xl
                        mt-8 px-3 py-2 hover:bg-mw_gray cursor-pointer"
