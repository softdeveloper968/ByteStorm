...
export const metadata = {
  title: "Agent Subscription - MustWants, Your PCS Partner",
  description:
    "Join MustWants as a vetted real estate agent. Subscribe to connect with military families, access exclusive leads, and enhance your business with our trusted home search platform.",
  robots: "index, follow",
};
      ...
      <section className="flex lg:px-10 lg:flex-row sm:flex-col mb-12">
        <div className="flex flex-col lg:w-2/3 sm:w-full">
          <h1 className="!text-2xl lg:!text-4xl font-bold mb-8 !mt-4">
            Real Estate Agent Subscription
          </h1>
          ...
          <div className="mb-12">
            ...
            <p className="text-left text-base lg:text-lg leading-normal">
          ...
          <div className="mb-12">
            ...
            <p className="text-left text-base lg:text-lg leading-normal mb-2">
            ...
            <p className="text-left text-base lg:text-lg leading-normal mb-2">
              ...
              cost on you, the Real Estate Agent, we are confident you will pass
          ...
          <div className="mb-12">
            ...
            <div className="flex flex-wrap text-left text-base lg:text-lg leading-normal">
